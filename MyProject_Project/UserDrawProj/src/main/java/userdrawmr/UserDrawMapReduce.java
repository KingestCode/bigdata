...
//		FileOutputFormat.setOutputPath(job1, new Path(args[1]));// 输出路径
		...
		FileInputFormat.addInputPath(job1, new Path("/Users/shixuanji/Documents/Code/Datas/userdraw/userdata.txt"));// 输入路径
		FileOutputFormat.setOutputPath(job1, new Path("/Users/shixuanji/Documents/Code/Datas/userdraw/out"));// 输出路径
...
//				FileOutputFormat.setOutputPath(job2, new Path(args[2]));// 输出路径
				FileInputFormat.addInputPath(job2, new Path("/Users/shixuanji/Documents/Code/Datas/userdraw/out"));// 输入路径
				FileOutputFormat.setOutputPath(job2, new Path("/Users/shixuanji/Documents/Code/Datas/userdraw/out2"));// 输出路径
