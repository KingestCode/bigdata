...
def crawl(link,f):
    for page in range(1, 31):
        ...
        for i in range(len(title)):
            ...
            output_dict = {"title":_title,"loc":_loc,"salary":_salary,"exp":_exp,"edu":_edu,"tags":_tags,"company":_company,"domain":_domain,"stage":_stage,"adv":_adv}
...
f = open("c:/lagou.json", "a", encoding="utf-8", newline="\n")
