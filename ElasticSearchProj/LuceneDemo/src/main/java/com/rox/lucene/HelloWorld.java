...
/**
 * Created by shixuanji on 2017/9/12.
 * <p>
...
public class HelloWorld {
    ...
    public void testCreate() throws IOException {
        ...
        article.setContent("找到好工作，迎娶小羊羊！");
...
//        Analyzer analyzer = new StandardAnalyzer();
    ...
    public void testDelete() throws IOException, ParseException {
        ...
        //LongPoint是建立索引的
        //Query query = LongPoint.newRangeQuery("id", 99L, 110);
    ...
    public void testMultiField() throws IOException, ParseException {
        ...
        Query query = queryParser.parse("大数");
    ...
    public void testBooleanQuery() throws Exception {
        ...
        BooleanClause bc2 = new BooleanClause(query2, BooleanClause.Occur.MUST_NOT);   //SHOULD:可满足可不满足
    ...
    public void testQueryParser() throws Exception {
        ...
        Query query = queryParser.parse("title:学好 OR title:学习");  // AND &&
